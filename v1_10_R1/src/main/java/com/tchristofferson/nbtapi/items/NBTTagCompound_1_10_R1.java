...
public class NBTTagCompound_1_10_R1 implements NBTTagCompound {

    private final net.minecraft.server.v1_10_R1.NBTTagCompound handle;

    public NBTTagCompound_1_10_R1(ItemStack itemStack) {
    ...
    public void setList(String tag, List<NBTBase> l) {
        ...
        for (NBTBase nbtBase : l) {
            nbtTagList.add((net.minecraft.server.v1_10_R1.NBTBase) nbtBase.getHandle());
        }
    ...
    public List<NBTBase> getList(String tag) {
        net.minecraft.server.v1_10_R1.NBTBase nbtBase = handle.get(tag);
        ...
        for (int i = 0; i < nbtTagList.size(); i++) {
            net.minecraft.server.v1_10_R1.NBTBase base = nbtTagList.get(i);
            list.add(NBTTypeUtil_1_10_R1.getWrapper(base));
        }
    ...
    public boolean equals(Object o) {
        return o instanceof NBTTagCompound_1_10_R1 && handle.equals(((NBTTagCompound_1_10_R1) o).getHandle());
    }
